const
	range = document.getElementById('money_range'),
    rangeV = document.getElementById('range_v'),
    btn_compare = document.getElementById('btn_compare'),
    spinner =  document.getElementById('spinner'),
    bar_progress = document.getElementById('progress_bar'),
    back_btn = document.getElementById('btn_back'),
    final_title = document.getElementById('final_title'),
	setValue = ()=>{
		const
