...
function progressBar(){
    progress_bar.style.width = (progressBarMultipleValue * count)+ "%";
    if (count > 1) {
...
(function (c) {
    var n = function (d, k) {
        ...
        this.back = function () {
            ...
            var a = h.pop();
            if (b.onBack && "function" === typeof b.onBack && !1 === b.onBack(f, e, a)) return h.push(a), !1;
        ...
        this.nextIndex = function () {
            var a = this.currentIndex(),
                c;
            do a++, (c = e.find('li:has([data-toggle="tab"])' + (b.withVisible ? ":visible" : "") + ":eq(" + a + ")"));
        ...
        this.nextTab = function () {
            return e.find('li:has([data-toggle="tab"]):eq(' + (a.currentIndex() + 1) + ")").length ? e.find('li:has([data-toggle="tab"]):eq(' + (a.currentIndex() + 1) + ")") : null;
        };
